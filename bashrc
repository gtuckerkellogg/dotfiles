...
if [[ "$__BASH_PROFILE_FINISHED" == "" ]] ; then
...
## managing the history (in .bash_history) 
...
#     # Prof Greg's prompt
     if [ "$(type -t __git_ps1)"  = "function" ] ; then
        PS1='${debian_chroot:+($debian_chroot)}\[\033[1;32m\]\u@\h\[\033[0m\]\n\[\033[1;34m\][\W\[\033[1;34m\]$(__git_ps1 "\[\033[1;31m\]-(git:%s)")\[\033[1;34m\]\[\033[1;34m\]]\[\033[0m\] '
     else 
        PS1='${debian_chroot:+($debian_chroot)}\[\033[1;32m\]\u@\h\[\033[0m\]\n\[\033[1;34m\][\W\[\033[1;34m\]\[\033[1;34m\]\[\033[1;34m\]]\[\033[0m\] '
     fi
else
...
# We've already run set -o noclobber
...
export LOG_CFG=/home/gtk/src/gtt_docker/notebooks/logging.yaml
